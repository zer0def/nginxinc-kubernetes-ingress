...
.. list-table::
   ...
   * - ``proxy-protocol``
     ...
     - ``False``
     - `Proxy Protocol <https://github.com/nginxinc/kubernetes-ingress/tree/v1.11.2/examples/proxy-protocol>`_.
```
...
.. list-table::
   ...
   * - ``stream-snippets``
     ...
     - N/A
     - `Support for TCP/UDP Load Balancing <https://github.com/nginxinc/kubernetes-ingress/tree/v1.11.2/examples/tcp-udp>`_.
   * - ``main-template``
