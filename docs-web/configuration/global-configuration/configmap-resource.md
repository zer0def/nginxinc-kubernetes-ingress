...
.. list-table::
   ...
   * - ``resolver-addresses``
     ...
     - N/A
     - `Support for Type ExternalName Services <https://github.com/nginxinc/kubernetes-ingress/tree/v1.7.2/examples/externalname-services>`_.
   * - ``resolver-ipv6``
...
.. list-table::
   ...
   * - ``log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.7.2/internal/configs/version1/nginx.tmpl>`_ for the access log.
     - 
   * - ``log-format-escaping``
   ...
   * - ``stream-log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.7.2/internal/configs/version1/nginx.tmpl>`_.
     - 
...
.. list-table::
   ...
   * - ``proxy-protocol``
     ...
     - ``False``
     - `Proxy Protocol <https://github.com/nginxinc/kubernetes-ingress/tree/v1.7.2/examples/proxy-protocol>`_.
```
...
.. list-table::
   ...
   * - ``stream-snippets``
     ...
     - N/A
     - `Support for  TCP/UDP Load Balancing <https://github.com/nginxinc/kubernetes-ingress/tree/v1.7.2/examples/tcp-udp>`_.
   * - ``main-template``
...
.. list-table::
   ...
   * - ``opentracing``
     ...
     - ``False``
     - `Support for OpenTracing <https://github.com/nginxinc/kubernetes-ingress/blob/v1.7.2/examples/opentracing/README.md>`_.
   * - ``opentracing-tracer``
