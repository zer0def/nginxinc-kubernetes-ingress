...
.. list-table::
   ...
   * - ``resolver-addresses``
     ...
     - N/A
     - `Support for Type ExternalName Services <https://github.com/nginxinc/kubernetes-ingress/tree/v1.12.3/examples/externalname-services>`_.
   * - ``resolver-ipv6``
...
.. list-table::
   ...
   * - ``log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.12.3/internal/configs/version1/nginx.tmpl>`_ for the access log.
     - `Custom Log Format <https://github.com/nginxinc/kubernetes-ingress/tree/v1.12.3/examples/custom-log-format>`_.
   * - ``log-format-escaping``
   ...
   * - ``stream-log-format``
     ...
     - See the `template file <https://github.com/nginxinc/kubernetes-ingress/blob/v1.12.3/internal/configs/version1/nginx.tmpl>`_.
     -
...
.. list-table::
   ...
   * - ``proxy-protocol``
     ...
     - ``False``
     - `Proxy Protocol <https://github.com/nginxinc/kubernetes-ingress/tree/v1.12.3/examples/proxy-protocol>`_.
```
...
.. list-table::
   ...
   * - ``stream-snippets``
     ...
     - N/A
     - `Support for TCP/UDP Load Balancing <https://github.com/nginxinc/kubernetes-ingress/tree/v1.12.3/examples/tcp-udp>`_.
   * - ``main-template``
