...
func TestValidatePolicy_PassesOnDirectiveSafePolicyValues(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			if err := ValidatePolicy(test.policy, test.cfg.IsPlus, test.cfg.EnableOIDC, test.cfg.EnableAppProtect); err != nil {
...
func TestValidatePolicy_RejectsDirectiveBreakoutPolicyValues(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			err := ValidatePolicy(test.policy, test.cfg.IsPlus, test.cfg.EnableOIDC, test.cfg.EnableAppProtect)
			if err == nil {
