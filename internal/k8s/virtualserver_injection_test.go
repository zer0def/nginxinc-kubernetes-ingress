...
var virtualServerStringFields = []virtualServerField{
	...
	{"spec.add-header-inherit", func(vs *conf_v1.VirtualServer, v string) { vs.Spec.AddHeaderInherit = v }, "on", nil},
	...
	{"spec.routes[0].add-header-inherit", func(vs *conf_v1.VirtualServer, v string) {
		vs.Spec.Routes[0].AddHeaderInherit = v
	}, "on", nil},
